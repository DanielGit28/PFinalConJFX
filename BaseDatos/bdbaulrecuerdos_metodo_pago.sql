...
CREATE TABLE `metodo_pago` (
  ...
  `numeroTarjeta` varchar(26) NOT NULL,
  `fechaVencimiento` date NOT NULL,
  `codigoSeguridad` int NOT NULL,
  `idClientePago` int NOT NULL,
  PRIMARY KEY (`idMetodoPago`),
  KEY `idClientePago_idx` (`idClientePago`),
  CONSTRAINT `idClientePago` FOREIGN KEY (`idClientePago`) REFERENCES `usuario_final` (`idusuariofinal`)
...
INSERT INTO `metodo_pago` VALUES (10,'5424567898985413','2020-10-01',769,1);
