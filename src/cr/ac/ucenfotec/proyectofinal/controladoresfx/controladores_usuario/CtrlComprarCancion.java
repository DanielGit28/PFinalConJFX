...
public class CtrlComprarCancion implements Initializable {
    ...
    @FXML
    private Button btnComprarCancionSeleccionada;
     ...
     * @throws IOException
     */
    public void escenaCrearComprarCancion(ActionEvent event) throws IOException {
        if(cancionSeleccionada == null) {
            gestor.creacionAlertas("Debe seleccionar una canción para comprar");
        } else {
            URL url = getClass().getResource("../../vistas/vistas_usuario/pagarCancion.fxml");
            ...
            stage.show();
            CtrlPagarCancion controller = loader.getController();
            controller.setUsuarioSesion(usuario, cancionSeleccionada);
        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        columnPrecio.setCellValueFactory(new PropertyValueFactory<Cancion, Integer>("precioCancion"));
